      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ color: '#6b7280', fontSize: '16px' }}>
            {coachInfo ? `Join ${coachInfo.business_name}` : 'Sign up to get started'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ backgroundColor: '#fff', padding: '32px', borderRadius: '12px', border: '1px solid #e5e7eb' }}>
          ...
          <p style={{ textAlign: 'center', marginTop: '20px', fontSize: '14px', color: '#6b7280' }}>
            ...
            <Link href={coachSlug ? `/login?coach=${coachSlug}` : '/login'} style={{ color: '#2563eb', textDecoration: 'none' }}>Sign in</Link>
          </p>

          <div style={{ marginTop: '20px', paddingTop: '20px', borderTop: '1px solid #e5e7eb' }}>
            <p style={{ textAlign: 'center', fontSize: '14px', color: '#6b7280' }}>
              Are you a coach?{' '}
              <Link href="/coach/signup" style={{ color: '#2563eb', textDecoration: 'none' }}>Start coaching</Link>
            </p>
          </div>
        </form>
      </div>
